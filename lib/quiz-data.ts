...
export const questions: Question[] = [
  ...
  },
  {
    ...
    options: [
      "여자친구/남자친구 화났을 때 기분 풀어줄 때 나온 음식",
      "수능/면접 전에 먹었던 음식",
      "가족끼리 자주 먹었던 음식",
      "올해 마지막으로 먹고 싶은 음식"
    ]
...
export const results: Result[] = [
  {
    id: "humanity",
    name: "인간미 넘치는 밥심이",
    description: "“맛은 분위기와 추억까지 포함이다.”\n\n특징: 오래된 맛집과 단골집을 좋아하며, 혼자보다 사람들과 먹는 걸 중요하게 생각합니다. 음식에 추억과 감정이 담겨있어 “여긴 진짜 아는 사람만 안다” 스타일의 맛집을 선호합니다.\n\n👉 음식은 단순 끼니가 아니라 관계와 추억이다.",
    tags: ["노포맛집", "추억음식", "찐친", "가성비"]
  },
  {
    id: "efficiency",
    name: "효율 생존형 밥심이",
    description: "“일단 빠르고 든든하면 된다.”\n\n특징: 바쁘고 현실적인 스타일로, 음식 선택 기준이 속도와 효율입니다. 배달이나 간편식에 대한 거부감이 적고, 밥은 생존용 연료에 가깝습니다.\n\n👉 먹는 것도 전략이다. 시간 아끼는 게 최고.",
    tags: ["스피드", "가성비", "효율중시", "간편식"]
  },
  {
    id: "healing",
    name: "감성 힐링 밥심이",
    description: "“힘들 땐 맛있는 걸 먹어야 회복된다.”\n\n특징: 음식으로 감정을 회복하는 타입입니다. 단 음식이나 위로가 되는 음식을 좋아하며, 분위기 좋은 맛집에서 위안과 행복을 느낍니다.\n\n👉 밥심은 곧 멘탈 관리다.",
    tags: ["디저트", "나를위한보상", "위로음식", "멘탈회복"]
  },
  {
    id: "stimulation",
    name: "자극 폭발 밥심이",
    description: "“스트레스? 매운맛과 칼로리로 날린다.”\n\n특징: 자극적인 매운 음식이나 기름진 음식을 좋아합니다. 감정 표현이 솔직하고 에너지가 강하며, 먹을 때만큼은 제대로 즐기려 합니다.\n\n👉 먹는 순간만큼은 화끈하게 간다.",
    tags: ["매운맛", "칼로리폭탄", "웨이팅감수", "스트레스해소"]
  },
  {
    id: "solo",
    name: "프로 혼밥 밥심이",
    description: "“혼자 먹는 시간이 가장 편하다.”\n\n특징: 혼밥 능력 만렙! 사람보다 음식 자체에 집중하며, 조용하고 편안한 식사를 선호합니다. 자신만의 확고한 취향을 가지고 있습니다.\n\n👉 혼밥은 외로움이 아니라 취향이다.",
